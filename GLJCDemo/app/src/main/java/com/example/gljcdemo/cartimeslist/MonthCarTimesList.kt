...
@Preview
@Composable
fun MonthCarTimesListPreview() {
    var carTimesArray = intArrayOf(6, 13, 37, 25)
    MonthCarTimesList(carTimesArray)
}

@Composable
fun MonthCarTimesList(carTimesArray: IntArray) {
    ...
    val carTimesArray7 = intArrayOf(18, 15, 20, 16)
